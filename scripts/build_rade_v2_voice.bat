...
if not exist ht_coeff.h (
    echo エラー: ht_coeff.h がありません。DR-NOPY の src からコピーしてください。
    goto :done
)
...
rem V2 本体
set SRCS_V2=rade_v2_voice.c rade_api_v2.c rade_rx_v2.c rade_extract_v2.c rade_eoo_v2.c rade_frame_sync.c rade_dec_v2.c rade_enc_v2.c rade_tx_v2.c rade_sync_v2.c rade_sync_data.c rade_dec_v2_data.c rade_enc_v2_data.c rade_v2_constants_data.c kiss_fft.c rade_bpf_v2.c krl_eoo_encode.c
